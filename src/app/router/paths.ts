export const appPaths = {
  ...
  caActivationDetails: (id?: string) => ({
    format: "/corporate-agent/network/activation/:id",
    path: `/corporate-agent/network/activation/${id ? encodeURIComponent(id) : "ACT-CA-2026-008472"}`,
  }),
  installerDashboard: "/installer/dashboard",
  installerJobs: "/installer/jobs",
  installerJobsActive: "/installer/jobs/active",
  installerJobsPending: "/installer/jobs/pending-verification",
  installerJobsCompleted: "/installer/jobs/completed",
  installerJobsDisputed: "/installer/jobs/disputed",
  installerJobsEasyBuy: "/installer/jobs/easybuy",
  installerJobsEasyBuyDetails: (jobId?: string) => ({
    format: "/installer/jobs/easybuy/:jobId",
    path: `/installer/jobs/easybuy/${jobId ? encodeURIComponent(jobId) : "JOB-2026-00847"}`,
  }),
  installerJobDetails: (jobId?: string) => ({
    format: "/installer/jobs/:jobId",
    path: `/installer/jobs/${jobId ? encodeURIComponent(jobId) : "JOB-2026-00847"}`,
  }),
  installerEarnings: "/installer/earnings",
