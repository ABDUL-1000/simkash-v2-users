...
interface InstalmentPaymentSuccessModalProps {
  open: boolean;
...
export const InstalmentPaymentSuccessModal: React.FC<
  InstalmentPaymentSuccessModalProps
> = ({
  open,
  onOpenChange,
  amount,
  ...
  return (
    <AppModal open={open} onOpenChange={onOpenChange} size="sm" footer={null}>
      <div className="py-2 text-center space-y-4 text-xs">
        ...
        <h3 className="text-base font-bold text-slate-900">Payment Applied!</h3>
        ...
        <div className="space-y-2 text-left font-medium text-xs px-2">
          ...
          <div className="flex justify-between text-slate-500">
            <span>% paid</span>
            <span className="font-bold text-[#10B981]">61.5%</span>
          </div>
          <div className="flex justify-between text-slate-500">
            <span>Periods left</span>
            <span className="font-semibold text-slate-800">11 remaining</span>
          </div>
          <div className="flex justify-between text-slate-500">
            <span>Next due</span>
        ...
        <div className="space-y-1.5 px-2">
          <div className="w-full h-2.5 bg-slate-100 rounded-full overflow-hidden">
            <div className="h-full bg-[#0F223D] rounded-full w-[61.5%]" />
          </div>
