...
import { PosSimDashboardStats } from "../components/DashboardStats";
import { PosSimNetworkSection } from "../components/PosNetworkSection";
import { PosSimInventoryPage } from "../components/pos-sim-inventory-table";
  ...
  return (
    <div>
      <div className="mx-auto w-full max-w-[1600px] space-y-6 p-4 sm:p-6 lg:p-8">
        <PageHeader
          title="POS SIM Management"
          description="POS SIM cards for remote monitoring and live streaming"
          actions={[
            {
              key: "redistribute",
              label: "Redistribute",
        ...
        />
        <PosSimDashboardStats />
        <PosSimNetworkSection />
        <PosSimInventoryPage />
      </div>
      <UploadSimModal
        open={uploadOpen}
