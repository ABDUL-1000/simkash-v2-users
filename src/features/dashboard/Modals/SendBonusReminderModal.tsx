...
export function SendBonusReminderModal({
  ...
  const defaultMessage = `Hi ${firstName}, you're at ${percentage}% of your bonus target (${currentActs} of ${targetActs} activations). ${daysLeft} days left to earn ${bonusAmount}! Keep activating. — ${scName}`;
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4 pt-1 text-xs">
        {/* Amber Performance Card (Matching Image 4) */}
