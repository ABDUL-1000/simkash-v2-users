...
type GMRecentlyAssignedWidgetProps = {
  onViewClick?: (id: string) => void;
};

export function GMRecentlyAssignedWidget({ onViewClick }: GMRecentlyAssignedWidgetProps) {
  const recentlyAssigned = [
    { id: "1", name: "Emeka Okonkwo", date: "5 Mar 2026" },
    { id: "2", name: "Amina Dikko", date: "22 Feb 2026" },
    { id: "3", name: "Bala Abdullahi", date: "10 Feb 2026" },
  ];
