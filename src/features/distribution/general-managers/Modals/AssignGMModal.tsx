...
type AssignGMModalProps = {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onAssignSuccess?: () => void;
};

export function AssignGMModal({
  open,
  onOpenChange,
  onAssignSuccess,
}: AssignGMModalProps) {
  ...
  return (
    <AppModal
      ...
      title="Assign General Manager Role"
      description="Grant a user General Manager access"
      size="md"
      actions={[
      ...
      <div className="space-y-4 text-xs sm:text-sm">
        ...
        <div className="space-y-2">
          ...
          <div className="rounded-2xl border border-[#DBEAFE] bg-[#EFF6FF] p-4 text-xs space-y-2">
            <strong className="font-bold text-[#2563EB] block text-sm">General Manager</strong>
