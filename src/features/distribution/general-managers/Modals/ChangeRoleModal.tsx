...
export function ChangeRoleModal({
  ...
  return (
    <AppModal
      ...
      title="Change Role"
      description={`${userName} · Currently: General Manager`}
      size="md"
      actions={[
    ...
    >
      <div className="space-y-4 text-xs sm:text-sm">
        ...
        <div className="space-y-1">
          <span className="rounded-xl bg-[#EFF6FF] px-3 py-1 font-bold text-[#2563EB] text-xs inline-block">
            • General Manager
          </span>
          ...
          <div className="space-y-2.5">
            ...
            <div className="rounded-2xl p-3.5 border border-[#E2E8F0] bg-[#F8FAFC] opacity-60 cursor-not-allowed">
              <span className="rounded-md bg-[#EFF6FF] px-2 py-0.5 font-bold text-[#2563EB] text-[11px] inline-block mb-1">
                • General Manager <span className="font-normal text-[#64748B]">(current)</span>
              </span>
            ...
            {/* Operational Manager */}
            <div
              onClick={() => setSelectedRole("operational")}
              className={`cursor-pointer rounded-2xl p-3.5 border transition-all ${
            ...
            >
              ...
              <p className="text-[11px] text-[#64748B]">Same access as General Manager</p>
            </div>
