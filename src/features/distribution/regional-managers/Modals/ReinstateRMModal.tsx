...
export function ReinstateRMModal({
  open,
  onOpenChange,
  userName = "Yusuf Adam Baba",
  onReinstateSuccess,
}: ReinstateRMModalProps) {
  ...
  return (
    <AppModal
      ...
      description={`${userName} · Regional Manager`}
      size="md"
      actions={[
    ...
    >
      <div className="space-y-4 text-xs sm:text-sm">
        <div className="rounded-2xl border border-[#A7F3D0] bg-[#ECFDF5] p-4 text-xs text-[#059669] font-medium leading-relaxed">
          Reinstating will immediately restore this user's Regional Manager dashboard access.
        </div>
        ...
        <div className="rounded-2xl border border-[#BFDBFE] bg-[#EFF6FF] p-4 text-xs space-y-1">
          ...
          <p className="text-[11px] text-[#64748B]">Suspended since: 10 Jul 2026</p>
