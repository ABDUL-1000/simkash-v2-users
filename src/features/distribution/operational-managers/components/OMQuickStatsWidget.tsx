...
export function OMQuickStatsWidget() {
  const stats = [
    { label: "Active", count: 14, color: "bg-[#059669]" },
    { label: "Suspended", count: 1, color: "bg-[#DC2626]" },
    { label: "Inactive", count: 0, color: "bg-[#94A3B8]" },
    { label: "Assigned this month", count: 2, color: "bg-[#9333EA]" },
  ];
