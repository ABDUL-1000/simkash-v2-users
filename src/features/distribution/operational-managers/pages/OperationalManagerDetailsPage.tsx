...
export default function OperationalManagerDetailsPage() {
    ...
    <div className="mx-auto w-full max-w-[1600px] space-y-6 p-4 sm:p-6 lg:p-8 text-xs sm:text-sm">
      ...
      <div className="rounded-2xl border border-[#E2ECF8] bg-white p-5 shadow-sm flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="flex size-14 shrink-0 items-center justify-center rounded-full bg-[#9333EA] font-extrabold text-white text-lg">
            YA
          </div>
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <h1 className="text-lg font-extrabold text-[#0F172A]">Yusuf Adam Baba</h1>
              <span className="rounded-md bg-[#F3E8FF] px-2.5 py-0.5 text-xs font-bold text-[#9333EA]">
                • Operational Manager
              </span>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6 min-w-0">
          ...
          <div className="rounded-2xl border border-[#E2ECF8] bg-white p-5 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 text-xs">
              ...
              <div>
                ...
                <span className="rounded-md bg-[#F3E8FF] px-2 py-0.5 font-bold text-[#9333EA] text-[11px] inline-block">
                  • Operational Manager
                </span>
              </div>
          ...
          <div className="rounded-2xl border border-[#E2ECF8] bg-white p-5 shadow-sm space-y-3">
            ...
            <p className="text-xs text-[#64748B]">Operational Manager sees only these sections in their dashboard</p>
        ...
        <div className="space-y-6 min-w-0 text-xs sm:text-sm">
          ...
          <div className="rounded-2xl border border-[#E2ECF8] bg-white p-5 shadow-sm space-y-3">
            ...
            <div className="space-y-2 text-xs">
              <span className="rounded-md bg-[#F3E8FF] px-2.5 py-1 font-bold text-[#9333EA] text-xs inline-block">
                • Operational Manager
              </span>
          ...
          <div className="rounded-2xl border border-[#E2ECF8] bg-white p-5 shadow-sm space-y-3">
            ...
            <div className="space-y-3 text-xs">
              {[
                ...
                { text: "Role assigned as Operational Manager", date: "14 Jan 2026", color: "bg-[#9333EA]" },
